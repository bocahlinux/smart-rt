...
| 3.17 | Frontend: Konfirmasi iuran (pengurus) | 20m | ⬜ |
| 3.18 | Frontend: Grafik pemasukan/pengeluaran | 45m | ⬜ |
| 3.19 | Frontend: Laporan view + download PDF | 30m | ⬜ |
| 3.20 | **Security Tests:** Warga cannot access other warga bukti transfer → 403 | 15m | ⬜ |
| 3.21 | **Security Tests:** Invalid file type upload → 415, oversized file → 413 | 15m | ⬜ |
| 3.22 | **Security Tests:** Audit log for confirmation/rejection | 10m | ⬜ |
